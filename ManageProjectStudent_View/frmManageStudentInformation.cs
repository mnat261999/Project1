...
namespace ManageProjectStudent_View
{
    public partial class frmManageStudentInformation : Form
    {
        ...
        //editvalue changed
        private void lkeFaculty_EditValueChanged(object sender, EventArgs e)
        {
            if (lkeFaculty.EditValue != null)
            {
                _lstClass = _Class.getListClass(lkeFaculty.EditValue.ToString());
                lkeClass.Properties.DataSource = _lstClass;
            }
        }
        //stt
